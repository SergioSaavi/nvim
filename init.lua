...
-- basic UX: hover + built-in completion
	...
	spec = {
		...
		},
		{
			...
			config = function()
				...
				-- Common root (optional but avoids “could not find vtsls” in monorepos)
				...
				local servers = {
					...
					-- volar (Vue Language Server) - note: lspconfig calls it 'volar', mason calls it 'vue-language-server'
					volar = {
						root_dir = function(fname)
							local util = require('lspconfig.util')
						...
						on_init = function(client)
							-- Forward tsserver requests from volar to vtsls
				...
				-- Mason calls the Vue server 'vue-language-server', but lspconfig calls it 'volar'
				-- Remove 'volar' from the list and add 'vue-language-server'
				...
				require('mason-lspconfig').setup {
					...
					handlers = {
						function(server_name)
							-- Mason calls vue server 'volar', but we configured it as 'volar' in lspconfig
							-- Mason-lspconfig automatically maps 'volar' to 'vue-language-server'
				...
				-- Manually attach vtsls to .vue files (workaround for auto-attach not working)
